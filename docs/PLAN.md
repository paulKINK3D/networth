...
- **4-tab structure:**
  ...
  3. **Accounts** — detailed inventory of YNAB accounts and manual assets, grouped into broad asset/liability sections with reconciled totals, 30-day activity, recent transactions, and manual value history.
